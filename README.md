...
- **استيراد ذكي**: فتح ملفات PDF, DOCX, TXT, Fountain, FDX مع تصنيف تلقائي
...
المعالج المسبق يُطبّق تطبيعاً خاصاً بنوع الملف: إزالة أرقام الصفحات من PDF، تحويل التنسيقات المرئية من DOCX، توحيد أحرف الأسطر.
