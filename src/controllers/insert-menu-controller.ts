...
export type InsertActionId = `insert-template:${EditorStyleFormatId}` | `photo-montage:${EditorStyleFormatId}`
...
export const isInsertActionId = (actionId: string): actionId is InsertActionId =>
  actionId.startsWith('insert-template:') || actionId.startsWith('photo-montage:')
