...
export function AppFooter({ stats, currentFormatLabel, isMobile }: AppFooterProps): React.JSX.Element {
  return (
    <footer
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4 text-[var(--muted-foreground)]">
          ...
          {!isMobile && <span className="hidden sm:inline">{stats.words} كلمة</span>}
          {!isMobile && <span className="hidden md:inline">{stats.characters} حرف</span>}
