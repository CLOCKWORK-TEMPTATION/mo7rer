export const createUiPrimitive = (moduleName: string, text?: string): HTMLElement => {
...
export const createUiButtonPrimitive = (moduleName: string, label = moduleName): HTMLButtonElement => {
