/**
 * @fileoverview colors.ts - لوحة ألوان المحرر (Jungle Green Edition)
 * 
 * @description
 * بيحدد كل الألوان المستخدمة في تطبيق "أفان تيتر". بيستخدم نظام ألوان Jungle Green
 * كـ theme رئيسي مع ألوان accent متنوعة للـ UI elements.
 * 
 * @theme Jungle Green
 * - #029784: اللون الأساسي (Jungle Green)
 * - #40A5B3: اللون الثانوي (Teal)
 * - #746842: لون التفاصيل (Bronze)
 * - #070100: الخلفية الداكنة
 * 
 * @exports
 * - colors: Array of all color hex codes used in the app
 * 
 * @usage
 * import { colors } from "@/constants/colors";
 * const primaryColor = colors[1]; // #029784
 * 
 * @author أفان تيتر - منصة النسخة
 * @version 1.0.0
 */
