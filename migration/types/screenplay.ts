/**
 * @fileoverview screenplay.ts - أنواع بيانات السيناريو (الأنواع الأساسية)
 * 
 * @description
 * الملف الأهم في المجلد types - بيحدد كل الـ types الأساسية للسيناريو.
 * بيشمل تنسيقات العرض، إحصائيات المستند، خيارات الخطوط، إعدادات المحرر،
 * معلومات المشاهد والشخصيات، والكثير.
 * 
 * @key_types
 * - ScreenplayFormat: تعريف تنسيق عرض لعنصر سينمائي
 * - DocumentStats: إحصائيات المستند (كلمات، حروف، صفحات، مشاهد)
 * - FontOption / TextSizeOption: خيارات الخطوط والأحجام
 * - EditorSettings: إعدادات المحرر
 * - SceneInfo / CharacterInfo: معلومات المشاهد والشخصيات
 * - LineType: نوع سطر التصنيف (action, dialogue, character, إلخ)
 * - FormatType: أنواع العناصر السينمائية
 * - ContextMemory / LineContext: ذاكرة السياق والسياق الحالي
 * 
 * @usage
 * import { LineType, DocumentStats, ScreenplayFormat } from "@/types/screenplay";
 * 
 * @author أفان تيتر
 * @version 1.0.0
 */
